		...
		do {
			...
			if ( roll == 1 ) {
				...
				turnTotal = 0;
					...
					turnTotal += roll;
					System.out.print( "\tYou have " + turnTotal + " ponits " );
				...
				if (ptot == 20 ) {
				// Tried to add this to the line in hopes it made the computer stop or win
				//at 20 points but this did not work.
				turnTotal = 0;
				System.out.println( "Computer has " + ctot + " points. Computer wins! " );
				
				do {
					roll = 1 + (int)(Math.random()*6);
					System.out.print( "\tComputer rolled a " + roll + "." );
					if (roll == 1 ) {
